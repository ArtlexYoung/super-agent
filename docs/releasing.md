...
Replace `0.1.57` with the version being released:

```bash
.venv/bin/python scripts/verify_release.py --version 0.1.57 --full --web
```
...
git commit -m "refactor(learning): release v0.1.57 with canonical evidence"
```
