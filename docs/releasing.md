...
v0.2.31 adds the optional Automation plugin for explicit event-driven work. Update `pyproject.toml`, `src/core/__init__.py`, the READMEs, and the release gate together.
