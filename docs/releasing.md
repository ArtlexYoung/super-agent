...
Replace `0.1.53` with the version being released:

```bash
.venv/bin/python scripts/verify_release.py --version 0.1.53 --full --web
```
...
git commit -m "refactor(models): release v0.1.53 with one model definition"
```
