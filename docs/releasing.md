...
Replace `0.1.50` with the version being released:

```bash
.venv/bin/python scripts/verify_release.py --version 0.1.50 --full --web
```
...
git commit -m "refactor(source): release v0.1.50 with strict size gates"
```
