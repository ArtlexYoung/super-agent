...
Replace `0.1.27` with the version being released:

```bash
.venv/bin/python scripts/verify_release.py --version 0.1.27 --full --web
```
...
git commit -m "refactor(source): release v0.1.27 with readable source layout"
git tag v0.1.27
```
