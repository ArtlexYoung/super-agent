...
v0.2.27 extracts conversation guidance into the optional Session plugin. Update `pyproject.toml`, `src/core/__init__.py`, the READMEs, and the release gate together.
