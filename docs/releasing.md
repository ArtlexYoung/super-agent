...
Replace `0.1.42` with the version being released:

```bash
.venv/bin/python scripts/verify_release.py --version 0.1.42 --full --web
```
...
git commit -m "refactor(release): release v0.1.42 with consolidated small owners"
git tag v0.1.42
```
