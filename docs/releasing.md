...
Replace `0.1.26` with the version being released:

```bash
.venv/bin/python scripts/verify_release.py --version 0.1.26 --full --web
```
...
git commit -m "feat(runtime): release v0.1.26 with budgeted group decisions"
git tag v0.1.26
```
